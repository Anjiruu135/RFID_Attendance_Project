...
{
    public partial class PopStudentSummary : Form
    {
        string connectionString = Database.connectionString;

        public PopStudentSummary()
        {
            InitializeComponent();
        }
        ...
        private async void PopStudentSummary_Load(object sender, EventArgs e)
        {
            await ShowSummary();
        }
            ...
            try
            {
                using (MySqlConnection connection = new MySqlConnection(connectionString))
                {
                    ...
                    string classAttendanceQuery = "SELECT User_ID, Fullname, view_total_student_attendance.Section, Total_Attendance, Total_Classes_Section FROM view_total_student_attendance " +
                                                  ...
                                                  "WHERE view_total_student_attendance.Section = @Section;";
