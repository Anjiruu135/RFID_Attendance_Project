...
namespace RFID_Attendance_Project.Modules
{
            ...
            try
            {
                ...
                if (ExcelFilePath != null && ExcelFilePath != "")
                {
                    try
                    {
                        ...
                        Excel.Quit();
                        System.Windows.Forms.MessageBox.Show("Excel file saved", "Excel Saved", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
                    catch (Exception ex)
                    {
